#Instalação dO postgresql-11 e do pgAdmin 4 versão 4.5 no - Ubuntu 19.04 desktop
#Autor: alterações Bruno moreto


#E IDEAL QUE O UBUNTU ESTEJA ATUALIZADO ANTES DE REALIZAR O SCRIPT

#1 - garantir que o python3.7 esteja instalado :  com o comando :       python3
...
#LOGAR COM O SUPER USUARIO COMANDO SUDO SU.
...
sudo nano lib/python3.7/site-packages/pgadmin4/config_local.py
...
cd ~/pgadmin4
sudo python lib/python3.7/site-packages/pgadmin4/pgAdmin4.py
