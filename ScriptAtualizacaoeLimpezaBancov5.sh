...
pg_dump -h localhost -U postgres -E utf8 -d hrto_limpeza > hrto_limpezaBackup.sql
...
psql -h localhost -U postgres -d hrto_limpezaBruno < hrto_limpezaBackup.sql
#senha do usuario aqui
...
psql -h localhost -U postgres -d hrto_limpezaBruno -f drop_tabela_schemaplubic.sql
#senha do usuario aqui
